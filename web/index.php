...
<html class="no-js" lang="en">
	<head>
		...
		<meta name="description" content="Crowdsource your problems. Contribute to challenging problems. Change the world. ©mindcloud">
		<meta name="keywords" content="crowdsource,problem-solving,mindcloud,problem,solution,innovation,challenge,opportunity">
				...
				<form data-abide="ajax" id="submit_problem">
				    ...
				    <div class="statement-field">
				    	<label>problem statement
				        	<input id="form_problem_statement" type="text" maxlength="140" placeholder="Why can't I type with my mind yet?" required/>
				     	</label>
				    ...
				    <div class="shorthand-field row collapse">
				    	<!-- shorthand label -->
						<label><span data-tooltip aria-haspopup="true" class="has-tip" title="Permanent problem URL. Autogenerated if not specified.">problem url</span>
							<small>
								&nbsp <span>optional</span>
							</small>
						</label>
						<!-- shorthand input -->
