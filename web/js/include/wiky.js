...
wiky.process_normal = function(wikitext) {
	...
	// Image
	{
		...
		while (index > -1 && end_index > -1) {
			...
			wikitext = wikitext.substring(0, index) + wiky.process_image(wikitext.substring(index + 7, end_index)) + wikitext.substring(end_index + 2);
	...
	// Video
	{
		...
		while (index > -1 && end_index > -1) {
			...
			wikitext = wikitext.substring(0, index) + wiky.process_video(wikitext.substring(index + 8, end_index)) + wikitext.substring(end_index + 2);
	...
	for (var i = 0; i < protocols.length; i++) {
		...
		while (index > -1 && end_index > -1) {
			...
			wikitext = wikitext.substring(0, index) + wiky.process_url(wikitext.substring(index + 1, end_index)) + wikitext.substring(end_index + 1);
