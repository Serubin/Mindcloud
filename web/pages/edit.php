    ...
    <div class="row">
        <form data-abide="ajax" id="edit-form" class="small-12 columns">
            ...
            <div class="hide-field">
                <input id="form_edit_hide" type="checkbox">
                <label for="form_edit_hide"><span data-tooltip aria-haspopup="true" class="has-tip" title="Hiding a post is a way to prevent users from viewing it without a link. This works for both Problems and Solutions.">Hide post?</span></label>
            </div>
