...
<p style="padding:10px;">This message was automaticly generated by <a style="color:#f7f7f7;border-bottom:1px #f7f7f7 dashed;text-decoration:none;" href="mindcloud.io">Mindcloud.io</a>. To <a href="mindcloud.io/preferences/unsubscribe">click here to unsubscribe</a>
</div>');
...
class Mail{
	...
	public static function send($email, $subject, $body){
		return Mail::mailer($email,"noreply@serubin.net","Mindcould - No Reply", $subject, $body, master);
	}
}
?>